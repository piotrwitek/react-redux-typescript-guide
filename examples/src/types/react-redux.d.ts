...
// T should be constrained to { T extends {[K in keyof T]: ActionCreator<A> }
// but it will require to add it on all the callers as well to make it work
type MapDispatchToPropsObject<TDispatchProps> = TDispatchProps;

type MapDispatchToProps<TDispatchProps, TOwnProps> =
    MapDispatchToPropsFunction<TDispatchProps, TOwnProps> | MapDispatchToPropsObject<TDispatchProps>;
