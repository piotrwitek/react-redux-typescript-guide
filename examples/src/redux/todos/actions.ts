...
export const actionCreators = {
  addTodo: (payload: string): IActions[typeof ADD_TODO] => ({
    type: ADD_TODO, payload,
  }),
  toggleTodo: (payload: string): IActions[typeof TOGGLE_TODO] => ({
    type: TOGGLE_TODO, payload,
  }),
  changeFilter: (payload: ITodosFilter): IActions[typeof CHANGE_TODOS_FILTER] => ({
